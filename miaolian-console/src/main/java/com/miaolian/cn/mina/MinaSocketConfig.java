...
public class MinaSocketConfig {
    ...
    public NioSocketAcceptor nioSocketAcceptor(BossMinaHandle bossMinaHandle, DefaultIoFilterChainBuilder defaultIoFilterChainBuilder) {
        ...
        nioSocketAcceptor.setHandler(bossMinaHandle);
    ...
    @Bean
    public DefaultIoFilterChainBuilder defaultIoFilterChainBuilder(ExecutorFilter executorFilter, MdcInjectionFilter mdcInjectionFilter, ProtocolCodecFilter protocolCodecFilter, LoggingFilter loggingFilter, KeepAliveFilter keepAliveFilter) {
    ...
    public KeepAliveFilter keepAliveFilter(){
        return new KeepAliveFilter(new KeepAliveMessage());}
